      ...
      <section className="md:flex">
        <div className="md:w-1/2 md:pt-[80px] md:ps-[190px] pt-10 ps-4 pe-4 md:pe-0">
          ...
          <form className="mb-[36px]">
            ...
            <div className="form-control relative md:mb-[56px] mb-8">
              {
                showPassword ? <FaFaceFlushed onClick={handleShowPass} className='absolute top-[40%] md:left-[43%] left-[90%] cursor-pointer text-2xl text-darkBlueOne' /> : <FaFaceDizzy onClick={handleShowPass} className='absolute top-[40%] md:left-[43%] left-[90%] cursor-pointer text-2xl text-darkBlueOne' />
              }
            ...
            <div className="form-control relative md:mb-[56px] mb-8">
              {
                showConfirmPassword ? <IoEyeOutline onClick={handleShowConfirmPass} className='absolute top-[40%] md:left-[43%] left-[90%] cursor-pointer text-2xl text-darkBlueOne' /> : <FaRegEyeSlash onClick={handleShowConfirmPass} className='absolute top-[40%] md:left-[43%] left-[90%] cursor-pointer text-2xl text-darkBlueOne' />
              }
              ...
              <input
                ...
                required
              />
              <Wavelabel classname={"absolute top-[30px] md:left-[37px] left-4 px-4 text-xl opacity-50 text-darkBlueOne peer-focus:top-[0px] peer-valid:top-[0px]  peer-focus:text-[14px] peer-valid:text-[14px] peer-focus:font-semibold peer-valid:font-semibold peer-focus:tracking-[1px] peer-valid:tracking-[1px] peer-focus:opacity-100 peer-valid:opacity-100 peer-focus:text-opacity-70 peer-valid:text-opacity-70 bg-white transition-all duration-300"} text={"ConfirmPassword"}></Wavelabel>
              {
                !confirmPassword ? <p className='absolute top-[90px] left-[10px] font-nunito text-red-600' >{confirmPasswordErr}</p> : <p className={`${confirmPassword === password ? "text-green-500" : "text-red-600"} absolute top-[90px] left-[10px] font-nunito`}>{`${confirmPassword === password ? "Password Matched" : "Password does not match"}`}</p>
              }
