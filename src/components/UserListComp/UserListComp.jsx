...
const UserListComp = ({ image, name, friendRequest, reqSent}) => {
  return (
    <div className="pe-3 pb-4 mb-4 border-b-[1px] border-gray-400 border-opacity-80 flex gap-4 items-center last:border-none">
      ...
      <div className="flex w-full justify-between">
        ...
        <div className="text-center">
          <p onClick={friendRequest} className="text-white text-[24px] font-poppins font-semibold bg-violet px-3 py-1 cursor-pointer active:scale-[0.95] rounded-[5px]">
            {reqSent?"-":"+"}
