...
const BlockedUserComp = ({ items, blockedName, blockedPhoto, handleUnblock, }) => {
      ...
      <div className="flex w-full justify-between">
        ...
        <div className="text-center">
          <p
            ...
            className="md:text-xl text-base font-poppins font-semibold text-white cursor-pointer bg-violet px-5 py-1 rounded-[5px] active:scale-[0.95]"
          >
            Unblock
          </p>
        </div>
